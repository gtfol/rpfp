...
const HomePage = () => {
  ...
  return (
    <div className="bg-orange-50 min-h-screen text-black">
      <NavBar isFixed={true} />
      <div className="mx-auto flex h-[calc(100vh-4rem)] max-w-3xl items-center">
                ...
                <div className="hidden font-semibold md:block">
                  {currentUser?.paid ? (
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <Button
                        variant="link"
                        className="h-auto p-0 text-sm text-primary hover:brightness-110"
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent className="w-56" align="end">
                    ...
                    <DropdownMenuItem onClick={() => setIsPayDialogOpen(true)}>
                      <button>
                        {currentUser?.paid ? "View Plan" : "Upgrade to Pro"}
                      </button>
                    </DropdownMenuItem>
                  </DropdownMenuContent>
                </DropdownMenu>
                    ...
                    {processedImage ? (
                      ...
                      <div className="flex h-64 items-center justify-center bg-gray-100">
                        {isProcessing ? (
                          ...
                          <p className="text-gray-500">
                            Click process to remove people
                          </p>
                        )}
                      </div>
                    )}
                ...
                <div className="flex justify-center space-x-4">
                  {!processedImage && (
                    <Button
                      ...
                      className="rounded-lg bg-primary px-6 py-3 text-white hover:bg-primary/90 disabled:bg-gray-400"
                    >
                  ...
                  {processedImage && (
                    <Button
                      onClick={() => {
                        const maxResolution = currentUser?.paid
                          ? "original"
                          : "720p";
            ...
            <div className="mt-12">
              ...
              <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
                <div className="rounded-lg bg-white p-6 shadow">
                  ...
                  <p className="text-gray-600">
                    Upload your image or drag and drop it into the upload area
                  </p>
                </div>
                <div className="rounded-lg bg-white p-6 shadow">
                  ...
                  <p className="text-gray-600">
                    Our AI automatically detects and removes people from your
                    photo
                  </p>
                </div>
                <div className="rounded-lg bg-white p-6 shadow">
                  <Undo className="mb-4 h-8 w-8 text-primary" />
                  <h3 className="mb-2 text-lg font-medium">
                    3. Download Result
                  </h3>
                  <p className="text-gray-600">
                    Download your processed image with people removed
                  </p>
                </div>
              </div>
            </div>
